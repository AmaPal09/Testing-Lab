...
def most_and_least_common_type(treats):
    ...
    Example:
    >>> most_and_least_common_type([{'type': 'dessert'} , {'type': 'drink'} , {'type': 'appetizer'},  {'type': 'drink'} ,{'type': 'appetizer'} , {'type': 'drink'}])
    ('drink', 'dessert')
    
    >>> most_and_least_common_type([{'type': 'dessert'}])
    ('dessert', 'None')

    >>> most_and_least_common_type([{'type': 'drink'} ,{'type':'drink'},{'type': 'drink'} , {'type':'drink'}])
    ('None', 'None')
